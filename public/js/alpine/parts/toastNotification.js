...
export const toastNotification = () => {
	Alpine.directive("toast-notification", (el, { modifiers, expression }, { evaluate, cleanup }) => {
		const id = "toast-notification-" + Date.now().toString(36) + Math.random().toString(36).substr(2, 5)
		el.dataset.toastNotification = id
				...
				<ul
					...
					<template x-for="(toast, index) in toasts" :key="toast.id">
						<li
							...
							class="absolute w-full duration-300 ease-out select-none sm:max-w-xs opacity-90"
								...
								<template x-if="!toast.html">
									<div class="relative">
										<div class="flex items-center"
											...
											<p class="text-base font-medium leading-none text-gray-700" x-text="toast.message"></p>
										</div>
